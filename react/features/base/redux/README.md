Echo - redux state persistence
====================================
Echo has a persistence layer that persists specific subtrees of the redux
...
When it's done, Echo will automatically persist these subtrees and
